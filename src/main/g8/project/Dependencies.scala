...
object Dependencies {
  ...
  lazy val amqpPlugin: Seq[ModuleID]       = Seq("org.galaxio" %% "gatling-amqp-plugin" % "0.8.0")
  $endif$
  $if(kafkaPlugin.truthy) $
  lazy val kafkaPlugin: Seq[ModuleID]      = Seq("org.galaxio" %% "gatling-kafka-plugin" % "0.9.0")
  ...
  lazy val jdbcPlugin: Seq[ModuleID]       = Seq("org.galaxio" %% "gatling-jdbc-plugin" % "0.7.0")
